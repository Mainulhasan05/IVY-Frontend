...
export const ChatInput = ({
  ...
  const {
    ...
    activarEnvioPorPalabraClave: true, // Enable keyword detection (e.g., "enviar", "listo")
    lang: "es-ES",
  });

  // Wrap startListening to pause audio before recording
  ...
  return (
    <div className="flex w-full items-center gap-2">
      ...
      <textarea
        ...
        value={isListening && tempText ? tempText : inputValue}
